...
local sets = {
    ...
    Precast_Default = {
        ...
        Body = 'Pinga Tunic', --13
        Hands = 'Acad. Bracers +1', --5
        Ring1 = 'Kishar Ring', --4
        Ring2 = 'Mallquis Ring',
        Back = 'Swith Cape +1',
        Waist = 'Embla Sash', --5
        Legs = 'Lengo pants', --5
        Feet = 'Acad. Loafers +1', --8
    },
    Cure_Precast = {
        Ear1 = 'Mendi. Earring',
        Feet = 'Vanya Clogs',
    ...
    Cure = {--I cap is 50, II cap is 30
        ...
        Ear2 = 'Regal Earring',
        Hands = 'Peda. Bracers +1',--II 2 and skill
        Ring1 = 'Lebeche Ring',
    ...
    Regen = {
        ...
        Body = { Name = 'Telchine Chas.', Augment = '"Regen" potency+2' },
...
profile.HandleMidcast = function()
    ...
    elseif (spell.Skill == 'Healing Magic') then
        ...
        if (spell.Element == weather.WeatherElement) and string.contains(spell.Name, 'cur') then
            gFunc.Equip('Waist', 'Hachirin-no-Obi');
            gFunc.Equip('Main', 'Chatoyant Staff');
            gFunc.Equip('Sub', 'Khonsu');
        end
        if (target.Name == me) then
